...
for _, strategy in helpers.each_strategy() do
  ...
  describe(":connect() [#" .. strategy .. "]", function()
    ...
    it("returns connection with ssl", function()
      ngx.IS_CLI = false
    ...
    it("returns connection using luasocket with ssl", function()
      ngx.IS_CLI = true
  ...
  describe(":setkeepalive() [#" .. strategy .. "]", function()
    ...
    it("return true when there is a stored connection with ssl", function()
      ngx.IS_CLI = false
    ...
    it("return true when there is a stored connection using luasocket with ssl", function()
      ngx.IS_CLI = true
    ...
    it("return true when there is no stored connection with ssl", function()
      ngx.IS_CLI = false
    ...
    it("return true when there is no stored connection using luasocket with ssl", function()
      ngx.IS_CLI = true
